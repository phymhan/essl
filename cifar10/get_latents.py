...
if __name__ == '__main__':
    ...
    if args.verify:
        ...
        imsave('data/verify.png', tensor2image(img))
        exit(0)
    ...
    if os.path.exists(args.data_path):
        ...
        for mode in ['train', 'test']:
            dataset = datasets.CIFAR10(args.data_root, download=True, transform=transform, train=mode=='train')
            dataset_ = datasets.CIFAR10(args.data_root, download=True, train=mode=='train')
